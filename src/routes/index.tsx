...
const LOOKUP: LookupEntry[] = [
  ...
  },
  {
    ...
    patient: {
      ...
      horario_agendado: "15:45",
      horario_chegada: "15:28",
      prioridade: "idoso",
  ...
  },
  {
    ...
    patient: {
      nome: "Miguel Batista",
      horario_agendado: "17:00",
      horario_chegada: "17:30",
  ...
  },
  {
    ...
    patient: {
      nome: "Abner Amorim",
      horario_agendado: "17:30",
      horario_chegada: "17:27",
      prioridade: "normal",
